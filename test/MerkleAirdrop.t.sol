...
import {DeployAirdrop} from "../script/DeployMerkleAirdrop.s.sol";

contract MerkleAirdropTest is ZkSyncChainChecker, Test {
    MerkleAirdrop public airdrop;
    PunkToken public token;

    bytes32 public ROOT = 0xaa5d581231e596618465a56aa0f5870ba6e20785fe436d5bfb82b08662ccc7c4;
    uint256 public constant AMOUNT_TO_CLAIM = 25 ether;
    uint256 public constant AMOUNT_TO_SEND = 25 * 4 ether;
    ...
    function testUsersCanClaim() public {
        ...
        assertEq(startingBalance + AMOUNT_TO_CLAIM, finalBalance);
    }
}
